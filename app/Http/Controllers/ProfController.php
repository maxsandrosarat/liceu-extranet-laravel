...
class ProfController extends Controller
{
    ...
    public function painelSimulados($provaId){
        ...
        $fundTurmas = Turma::whereIn('id', $profTurmas)->where('ensino','fund')->where('ativo',true)->orderBy('serie')->orderBy('turma')->get();
        $turmaIdsFund = array();
        ...
        $medioTurmas = Turma::whereIn('id', $profTurmas)->where('ensino','medio')->where('ativo',true)->orderBy('serie')->orderBy('turma')->get();
        $turmaIdsMedio = array();
