<?php $__env->startSection('body'); ?>
    <div class="card border">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    <form class="row gy-2 gx-3 align-items-center" action="/outro/notas" method="GET">
                        <?php echo csrf_field(); ?>
                    ...
                    <tr <?php if($nota->prazo==$data): ?> style="color:orange" <?php else: ?> <?php if($nota->prazo>$data): ?> style="color:green" <?php else: ?> <?php if($nota->prazo<$data): ?> style="color:red" <?php endif; ?> <?php endif; ?> <?php endif; ?>>
                        ...
                        <td>
                            ...
                            <?php $__currentLoopData = $nota->series; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="/outro/notas/painel/<?php echo e($nota->id); ?>/<?php echo e($serie->turma->id); ?>" class="badge bg-primary" data-toggle="tooltip" data-placement="right" title="Painel"><?php echo e($serie->turma->serie); ?>º ANO <?php echo e($serie->turma->turma); ?></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </td>
...
<?php echo $__env->make('layouts.app', ["current"=>"pedagogico"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/outros/home_notas.blade.php ENDPATH**/ ?>