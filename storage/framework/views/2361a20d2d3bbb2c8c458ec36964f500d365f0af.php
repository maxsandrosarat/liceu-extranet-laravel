            ...
            <table class="table table-striped table-ordered table-hover">
                ...
                <tbody>
                    ...
                    <tr <?php if($sim->prazo==$data): ?> style="color:orange" <?php else: ?> <?php if($sim->prazo>$data): ?> style="color:green" <?php else: ?> <?php if($sim->prazo<$data): ?> style="color:red" <?php endif; ?> <?php endif; ?> <?php endif; ?>>
                        ...
                        <td>
                            <a href="/outro/conteudosProvas/painel/<?php echo e($sim->id); ?>" class="badge badge-primary" data-toggle="tooltip" data-placement="right" title="Painel"><i class="material-icons md-18">attach_file</i></a>
                        </td>
                        <td> 
                            <a href="/outro/simulados/painel/<?php echo e($sim->id); ?>" class="badge badge-primary" data-toggle="tooltip" data-placement="right" title="Painel"><i class="material-icons md-18">attach_file</i></a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
...
<?php echo $__env->make('layouts.app', ["current"=>"simulados"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/outros/home_simulados.blade.php ENDPATH**/ ?>