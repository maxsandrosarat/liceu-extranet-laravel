            ...
            <table class="table table-striped table-ordered table-hover" style="text-align: center;">
                ...
                <tbody>
                    ...
                    <tr style="background-color: green;">
                        ...
                        <?php $__currentLoopData = $fundTurmas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $turma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td>
                            <a target="_blank" href="/outro/conteudosProvas/pdf/<?php echo e($prova->id); ?>/<?php echo e($turma->serie); ?>" class="btn btn-primary"><?php echo e($turma->serie); ?>º ANO</a>
                        </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tr>
                </tbody>
...
<?php echo $__env->make('layouts.app', ["current"=>"simulados"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/outros/conteudos_provas.blade.php ENDPATH**/ ?>