        ...
        <h5 class="card-title">Painel de Atividades Complementares</h5>
            ...
            <div class="modal fade" id="exampleModalNovo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="/prof/atividadeComplementar" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
            ...
            <?php if(count($atividades)==0): ?>
                    <div class="alert alert-dark" role="alert">
                        ...
                        <a href="/prof/atividade" class="btn btn-sm btn-success">Voltar</a>
                        <?php endif; ?>
                    </div>
            <?php else: ?>
            <div class="card border">
                <h5 class="card-title">Filtros:</h5>
                    <form class="form-inline my-2 my-lg-0" method="GET" action="/prof/atividadeComplementar/filtro">
                        <?php echo csrf_field(); ?>
            ...
            <div class="table-responsive-xl">
                ...
                ?>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Atividade: <?php echo e($atividade->descricao); ?> <?php if($atividade->impresso==false): ?><a type="button" disabled class="badge badge-success" data-toggle="tooltip" data-placement="bottom" title="Impresso"><i class="material-icons">print</i></a><?php else: ?> <a type="button" 	disabled class="badge badge-warning" data-toggle="tooltip" data-placement="bottom" title="Não Impresso"><i class="material-icons">print</i></a> <?php endif; ?></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a type="button" class="badge badge-success" href="/prof/atividadeComplementar/download/<?php echo e($atividade->id); ?>"><i class="material-icons md-48">cloud_download</i></a> <button type="button" class="badge badge-warning" data-toggle="modal" data-target="#modalEditar<?php echo e($atividade->id); ?>"><i class="material-icons md-48">edit</i></button> <a type="button" class="badge badge-danger" href="#" data-toggle="modal" data-target="#exampleModalDelete<?php echo e($atividade->id); ?>" data-toggle="tooltip" data-placement="bottom" title="Excluir Atividade"><i class="material-icons md-48">delete</i></a> <br/> <hr/>
                            <!-- Modal Editar -->
                            <div class="modal fade" id="modalEditar<?php echo e($atividade->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="/prof/atividadeComplementar/editar/<?php echo e($atividade->id); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <label for="turma">Turma</label>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-footer">
                                    <a type="button" class="btn btn-danger" href="/prof/atividadeComplementar/apagar/<?php echo e($atividade->id); ?>">Excluir</a>
