            ...
            <table class="table table-striped table-ordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="badge badge-warning" data-toggle="modal" data-target="#exampleModal<?php echo e($outro->id); ?>" data-toggle="tooltip" data-placement="left" title="Editar">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($outro->name); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e($outro->email); ?>" required autocomplete="email">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($outro->ativo==1): ?>
                                <a href="/admin/colaborador/apagar/<?php echo e($outro->id); ?>" class="badge badge-secondary" data-toggle="tooltip" data-placement="right" title="Inativar"><i class="material-icons md-18 red">disabled_by_default</i></a>
                            <?php else: ?>
                                <a href="/admin/colaborador/apagar/<?php echo e($outro->id); ?>" class="badge badge-secondary" data-toggle="tooltip" data-placement="right" title="Ativar"><i class="material-icons md-18 green">check_box</i></a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
