    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('responsavel.login.submit')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ["current"=>"login-resp"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/auth/responsavel-login.blade.php ENDPATH**/ ?>