<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if($current=="estoque"): ?> active <?php endif; ?>" href="/admin/estoque">Estoque</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if($current=="estoque"): ?> active <?php endif; ?>" href="/outro/estoque">Estoque</a>
            </li>
            <li class="nav-item">
