            ...
            <form action="/admin/listaCompras" method="POST">
                ...
                <?php $__currentLoopData = $prods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge badge-primary badge-pill"><?php echo e($prod->estoque); ?></span>
                    </li>
                ...
                <div class="input-group mb-3">
                    <input id="input-prodEx" type="text" class="form-control" name="produtoExtra">
...
<?php echo $__env->make('layouts.app', ["current"=>"estoque"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/admin/lista_compra_selecionar.blade.php ENDPATH**/ ?>