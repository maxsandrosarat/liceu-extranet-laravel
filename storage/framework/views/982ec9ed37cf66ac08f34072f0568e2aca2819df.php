                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col" style="text-align: right">
                                <button type="button" class="badge badge-danger" data-toggle="modal" data-target="#exampleModalDeleteDia<?php echo e($diario->id); ?>" data-toggle="tooltip" data-placement="left" title="Excluir"><i class="material-icons md-18">delete</i></button></td>
                            </div>
                            <!-- Modal -->
                                        ...
                                        <thead class="thead-dark">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="badge badge-secondary" data-toggle="modal" data-target="#exampleModalFoto<?php echo e($aluno->id); ?>"><?php echo e($aluno->name); ?></button></td>
                                                        <!-- Modal -->
                                ...
                                <tr>
                                    ...
                                    <td <?php if($ocorrencia->aprovado===0 || $ocorrencia->aprovado===1): ?>colspan="2" <?php endif; ?>>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                        <button type="button" class="badge badge-warning" data-toggle="modal" data-target="#exampleModal<?php echo e($ocorrencia->id); ?>" data-toggle="tooltip" data-placement="left" title="Editar">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade bd-example-modal-lg" id="exampleModalDelete<?php echo e($ocorrencia->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Ocorrência Nº <?php echo e($ocorrencia->id); ?></h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
