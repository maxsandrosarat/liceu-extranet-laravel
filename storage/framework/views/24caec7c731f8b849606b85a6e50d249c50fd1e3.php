                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="POST" action="/prof/conteudosProvas/anexar/<?php echo e($contFund->id); ?>" enctype="multipart/form-data">
                                                        <?php echo csrf_field(); ?>
                                                        <textarea class="form-control" name="descricao" id="descricao" rows="10" cols="40" maxlength="500" placeholder="Escreva aqui ou copei e cole do arquivo, a descrição completa dos conteúdos que serão cobrados."><?php if($contFund->descricao!=''): ?><?php echo e($contFund->descricao); ?><?php endif; ?></textarea>
                                                </div>
...
<?php echo $__env->make('layouts.app', ["current"=>"simulados"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/profs/conteudos_provas.blade.php ENDPATH**/ ?>