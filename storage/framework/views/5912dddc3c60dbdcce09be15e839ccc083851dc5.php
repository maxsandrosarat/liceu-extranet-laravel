                ...
                ?>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-footer">
                            <a type="button" class="badge bg-success" href="/outro/atividadeDiaria/download/<?php echo e($atividade->id); ?>"><i class="material-icons md-48">cloud_download</i></a> <br/> <hr/>
                        </div>
                        </div>
                    </div>
                    </div>
...
<?php echo $__env->make('layouts.app', ["current"=>"pedagogico"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/outros/atividade_diaria_outro.blade.php ENDPATH**/ ?>