                    ...
                    <tr style="background-color: green;">
                        ...
                        <td>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form id="form-conteudos<?php echo e($fundTurma->id); ?>" method="POST" action="/outro/conteudosProvas/pdf/<?php echo e($prova->id); ?>/<?php echo e($fundTurma->id); ?>">
                                        <?php echo csrf_field(); ?>
                    ...
                    <tr style="background-color: green;">
                        ...
                        <td>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form id="form-conteudos<?php echo e($medioTurma->id); ?>" method="POST" action="/outro/conteudosProvas/pdf/<?php echo e($prova->id); ?>/<?php echo e($medioTurma->id); ?>">
                                        <?php echo csrf_field(); ?>
                                        <h5>Selecione as disciplinas:</h5>
                                        <ul class="list-group">
...
<?php echo $__env->make('layouts.app', ["current"=>"provas"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/outros/conteudos_provas.blade.php ENDPATH**/ ?>