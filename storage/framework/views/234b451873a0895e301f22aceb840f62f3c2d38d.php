<?php $__env->startSection('body'); ?>
    <div class="card border">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    <form class="row gy-2 gx-3 align-items-center" action="/prof/atividadeComplementar" method="GET">
                        <?php echo csrf_field(); ?>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr <?php if($atividade->data_fim==$data): ?> style="color:orange" <?php else: ?> <?php if($atividade->data_fim>$data): ?> style="color:green" <?php else: ?> <?php if($atividade->data_fim<$data): ?> style="color:red" <?php endif; ?> <?php endif; ?> <?php endif; ?>>
                        ...
                        <td>
                            <a href="/prof/atividadeComplementar/painel/<?php echo e($atividade->id); ?>" class="badge bg-primary" data-toggle="tooltip" data-placement="right" title="Painel"><i class="material-icons md-18">attach_file</i></a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
...
<?php echo $__env->make('layouts.app', ["current"=>"atividade"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/profs/home_atividades_complementares.blade.php ENDPATH**/ ?>