                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($qtd==0 && $qtdEx==0): ?>
                            <?php else: ?>
                            <a target="_blank" href="/outro/listaCompras/pdf/<?php echo e($lista->id); ?>" class="badge bg-success">Gerar PDF</a>
                            <?php endif; ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <a href="/outro/listaCompras/apagar/<?php echo e($lista->id); ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Inativar">Excluir</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
