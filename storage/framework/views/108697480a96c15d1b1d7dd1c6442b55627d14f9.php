                              ...
                              <div id="flush-collapse<?php echo e($diario->id); ?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?php echo e($diario->id); ?>" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <b><p>
                                        ...
                                        <br/><br/>
                                        <a type="button" <?php if($diario->conferido===0): ?> href="/admin/diario/conferido/<?php echo e($diario->id); ?>" class="badge bg-warning" <?php else: ?> class="badge bg-success" <?php endif; ?>>
                                        ...
                                        <button type="button" class="badge bg-warning" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo e($diario->id); ?>">
                                            <i class="material-icons md-18">edit</i>
                                        </button>
                                        <button type="button" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#exampleModalDelete<?php echo e($diario->id); ?>"><i class="material-icons md-18">delete</i></button></td>
                                        <!-- Modal -->
                                        ...
                                        <div class="modal fade" id="exampleModal<?php echo e($diario->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="row g-3" method="POST" action="/admin/diario/editar/<?php echo e($diario->id); ?>">
                                                            <?php echo csrf_field(); ?>
                                                            <b>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <a href="/admin/ocorrencias/aprovar/<?php echo e($ocorrencia->id); ?>" class="badge bg-success" data-toggle="tooltip" data-placement="bottom" title="Aprovar"><i class="material-icons white">thumb_up</i></a>
                                                <a href="/admin/ocorrencias/reprovar/<?php echo e($ocorrencia->id); ?>" class="badge bg-danger" data-toggle="tooltip" data-placement="bottom" title="Reprovar"><i class="material-icons white">thumb_down</i></a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', ["current"=>"pedagogico"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\liceu-extranet-laravel\resources\views/admin/diario_admin.blade.php ENDPATH**/ ?>