...
<div class="card border">
    <div class="card-body">
    <a href="/outro/provas/<?php echo e($ano); ?>" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Voltar"><i class="material-icons white">reply</i></a>
    <br/><br/>
                                ...
                                <?php if($contFund->disciplina->nome == $fundDisc->nome && $contFund->turma->serie==$fundTurma->serie && $contFund->turma->turma==$fundTurma->turma): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <a type="button" class="badge bg-success" href="/outro/provas/download/<?php echo e($contFund->id); ?>"><i class="material-icons md-18">cloud_download</i></a>
                            ...
                            <?php $__currentLoopData = $contMedios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contMedio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <a type="button" class="badge bg-success" href="/outro/provas/download/<?php echo e($contMedio->id); ?>"><i class="material-icons md-18">cloud_download</i></a>
...
<?php echo $__env->make('layouts.app', ["current"=>"provas"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u302411308/domains/colegioliceu2.com.br/resources/views/outros/provas.blade.php ENDPATH**/ ?>