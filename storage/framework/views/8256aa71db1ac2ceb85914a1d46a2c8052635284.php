                                        ...
                                        <?php if($fundPertence===0): ?> <td style="color:blue; text-align: center; font-weight:bold;">Não se <br/>Aplica</td> <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <a type="button" class="badge badge-success" href="/prof/planejamentos/download/<?php echo e($contFund->id); ?>"><i class="material-icons md-18">cloud_download</i></a>
                                ...
                                <?php if($contMedio->disciplina->nome == $medioDisc->nome && $contMedio->serie==$turma->serie): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <a type="button" class="badge badge-success" href="/prof/planejamentos/download/<?php echo e($contMedio->id); ?>"><i class="material-icons md-18">cloud_download</i></a>
                                    <?php endif; ?>
                                    </td>
                                    <!-- Modal Anexar -->
