                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($qtd==0 && $qtdEx==0): ?>
                            <?php else: ?>
                            <a target="_blank" href="/admin/listaCompras/pdf/<?php echo e($lista->id); ?>" class="badge badge-success">Gerar PDF</a>
                            <?php endif; ?>
                            <button type="button" class="badge badge-danger" data-toggle="modal" data-target="#exampleModalDelete<?php echo e($lista->id); ?>"><i class="material-icons md-18">delete</i></button></td>
                            <!-- Modal -->
