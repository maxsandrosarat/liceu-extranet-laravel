        ...
        <div class="col-md-8">
            <div class="card border">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form class="row g-3" id="form-relatorio" method="POST" action="/outro/diario/relatorio">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-auto form-floating">
                            <select class="form-select mr-sm-2" id="turma" name="turma" required>
                                <option value="">Selecione</option>
                                    ...
                                    <option <?php if($turma->ativo==false): ?> style="color: red;" <?php endif; ?> value="<?php echo e($turma->id); ?>"><?php echo e($turma->serie); ?>º<?php echo e($turma->turma); ?><?php echo e($turma->turno); ?></option>
...
<?php echo $__env->make('layouts.app', ["current"=>"pedagogico"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\liceu-extranet-laravel\resources\views/outros/diario_relatorio.blade.php ENDPATH**/ ?>