...
<div class="card border">
    <div class="card-body">
    <a href="/outro/planejamentos/{{$ano}}" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Voltar"><i class="material-icons white">reply</i></a>
    <br/><br/>
                                ...
                                @if($contFund->disciplina->nome == $fundDisc->nome && $contFund->turma->serie==$fundTurma->serie && $contFund->turma->turma==$fundTurma->turma)
                                    ...
                                    @else
                                        ...
                                        @else
                                            ...
                                            @endif
                                        @endif
                                        <a type="button" class="badge bg-success" href="/outro/planejamentos/download/{{$contFund->id}}"><i class="material-icons md-18">cloud_download</i></a>
                                    @endif
                                    </td>
                                            <!-- Modal Conferir -->
                            ...
                            @foreach ($contMedios as $contMedio)
                                ...
                                @else
                                        ...
                                        @else
                                            ...
                                            @endif
                                        @endif
                                    <a type="button" class="badge bg-success" href="/outro/planejamentos/download/{{$contMedio->id}}"><i class="material-icons md-18">cloud_download</i></a>
                                    @endif
                                </td>
                                        <!-- Modal Conferir -->
