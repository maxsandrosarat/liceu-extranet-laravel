                          ...
                          <div id="flush-collapse{{$diario->id}}" class="accordion-collapse collapse" aria-labelledby="flush-heading{{$diario->id}}" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <b><p>
                                    ...
                                    <br/><br/>
                                    <a type="button" @if($diario->conferido===0) href="/outro/diario/conferido/{{$diario->id}}" class="badge bg-warning" @else class="badge bg-success" @endif>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="row g-3" method="POST" action="/outro/diario/editar/{{$diario->id}}">
                                                        @csrf
                                                        <b>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <a href="/outro/ocorrencias/apagar/{{$ocorrencia->id}}" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Inativar">Excluir</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
