                    ...
                    <tr @if($nota->prazo==$data) style="color:orange" @else @if($nota->prazo>$data) style="color:green" @else @if($nota->prazo<$data) style="color:red" @endif @endif @endif>
                        ...
                        <td>
                            ...
                            @foreach ($nota->series as $serie)
                                <li>
                                    <a href="/outro/notas/painel/{{$nota->id}}/{{$serie->turma->id}}" class="badge bg-primary" data-toggle="tooltip" data-placement="right" title="Painel">{{$serie->turma->serie}}º ANO {{$serie->turma->turma}}</a>
                                </li>
                            @endforeach
                            </ul>
                        </td>
