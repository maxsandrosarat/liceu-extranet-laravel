...
@section('body')
    <div class="card border">
        <div class="card-body">
            <a href="/prof/pedagogico" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Voltar"><i class="material-icons white">reply</i></a>
            <br/><br/>
            @if(session('mensagem'))
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr @if($atividade->data_fim==$data) style="color:orange" @else @if($atividade->data_fim>$data) style="color:green" @else @if($atividade->data_fim<$data) style="color:red" @endif @endif @endif>
                        ...
                        <td>{{$atividade->ano}}</td>
                        <td>
                            <a href="/prof/atividadeComplementar/painel/{{$atividade->id}}" class="badge bg-primary" data-toggle="tooltip" data-placement="right" title="Painel"><i class="material-icons md-18">attach_file</i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
