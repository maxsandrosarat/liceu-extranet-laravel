...
<div class="card border">
    <div class="card-body">
    <a href="/admin/notas/{{$ano}}" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Voltar"><i class="material-icons white">reply</i></a>
    <br/><br/>
                                ...
                                @if($aluno->id == $lancamento->aluno->id && $disciplina->id==$lancamento->disciplina->id)
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="/admin/notas/zerar/{{$lancamento->id}}" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Zerar">Zerar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div style="text-align: center;" class="modal fade" id="exampleModalAnexar{{$lancamento->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="/admin/notas/lancar/{{$lancamento->id}}">
                                                    <h4>Aluno(a): {{$aluno->name}}</h4>
                                                    @csrf
